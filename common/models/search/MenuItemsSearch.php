...
/**
 * MenuItemsSearch represents the model behind the search form about `common\models\MenuItems`.
 */
class MenuItemsSearch extends MenuItems
{
    ...
    public function rules()
    {
        return [
            ...
            [['id', 'menu_id', 'parent_id', 'link_type', 'show_child', 'visible', 'order', 'author_id', 'updater_id', 'status'], 'integer'],
            [['title', 'icon', 'url', 'active'], 'safe'],
        ];
    }
     ...
     * @return ActiveDataProvider
     */
    public function searchByMenu($id, $params)
    {
        $query = MenuItems::find()->where(['menu_id' => $id]);
