...
return [
    ...
    '' => '',
    '' => '',
    'App Name' => 'Название сайта',
    'Admin email' => 'E-mail администратора',
    'Robot email' => 'E-mail для отправки сообщения',
    'Widget cachetime (ms)' => 'Время кэширования виджетов',
    'Upload max. file size' => 'Макс. размер файла для загрузки',
];
