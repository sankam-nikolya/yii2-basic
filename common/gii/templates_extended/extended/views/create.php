...
$this->title = <?php echo $generator->generateString('Create ' . Inflector::pluralize(Inflector::camel2words(StringHelper::basename(str_replace('Controller', '', $generator->controllerClass)))));?>;
